...
int main()
{
	...
	cout << "—ума елемент≥в, €к≥ задовольн€ють умову: " << suma << "\n" << "\n";
	cout << " ≥льк≥сть елемент≥в, €к≥ задовольн€ють умову: " << count << "\n" << "\n";
	cout << "«ам≥на елемент≥в, €к≥ задовольн€ють умову, нул€ми: " << "\n";
	Print(C, ROW_COUNT, COL_COUNT, i, j);
	for (int i = 0; i < ROW_COUNT; i++)
		delete[] C[i];
	delete[] C;
